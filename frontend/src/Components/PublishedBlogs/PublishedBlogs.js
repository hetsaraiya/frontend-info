						...
						>
							<div className="absolute right-4 bottom-4 flex flex-col gap-y-3 bg-white shadow-xl dark:shadow-[#F05225] dark:shadow-md dark:bg-[#101010] p-2 rounded-lg translate-x-[200%] group-hover:translate-x-0 transition-all duration-300">
								...
								<svg
									...
									viewBox="0 0 16 16"
									onClick={() => {
										document.getElementById("publishedBlog-" + record.id).style.transform = "scale(0.1)"
										document.getElementById("publishedBlog-" + record.id).style.opacity = "0"
										setTimeout(() => {
											document.getElementById("publishedBlog-" + record.id).classList.add("hidden")
										}, 300)
									}}
								>
